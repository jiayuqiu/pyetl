...
then
    ...
    bash /home/appuser/python_jobs/pyetl/bin/sdec_gc_all_spark_v2_stream_local.sh /home/appuser/python_jobs/pyetl > /home/appuser/python_jobs/pyetl/log/sdec_streaming.log &
fi
